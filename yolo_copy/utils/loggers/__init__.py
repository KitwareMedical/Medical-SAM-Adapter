...
from yolo_copy.utils.general import LOGGER, colorstr, cv2
from yolo_copy.utils.loggers.clearml.clearml_utils import ClearmlLogger
from yolo_copy.utils.loggers.wandb.wandb_utils import WandbLogger
from yolo_copy.utils.plots import plot_images, plot_labels, plot_results
from yolo_copy.utils.torch_utils import de_parallel
...
try:
    if RANK in {0, -1}:
        ...
        from yolo_copy.utils.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from yolo_copy.utils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
