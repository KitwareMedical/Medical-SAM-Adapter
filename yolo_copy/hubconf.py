...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from yolo_copy.models.common import AutoShape, DetectMultiBackend
    from yolo_copy.models.experimental import attempt_load
    from yolo_copy.models.yolo import ClassificationModel, DetectionModel, SegmentationModel
    from yolo_copy.utils.downloads import attempt_download
    from yolo_copy.utils.general import LOGGER, ROOT, check_requirements, intersect_dicts, logging
...
if __name__ == "__main__":
    ...
    from yolo_copy.utils.general import cv2, print_args
